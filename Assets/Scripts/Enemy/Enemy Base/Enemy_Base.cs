...
public abstract class Enemy_Base : MonoBehaviour
{
    ...
    private IEnumerator HitEffect(GameObject player, int hitCount, int damage, bool isCritcal)
    {
        for (int i = 0; i < hitCount; i++)
        {
            ...
            // Hit Damage Effect -> UI 출력 관련 무언가
            if(isCritcal)
            {
                // 크리티컬 이펙트
                switch (enemyType)
                {
                    ...
                    case EnemyType.Tower:
                    case EnemyType.Part:
                        //statusUI_Normal.DamageUI(true, damage);
                        break;

                    case EnemyType.Boss:
                    case EnemyType.BossTower:
                        //statusUI_Boss.DamageUI(true, damage);
                        break;
                }
            }
            else
            {
                ...
                switch (enemyType)
                {
                    ...
                    case EnemyType.Tower:
                    case EnemyType.Part:
                        //statusUI_Normal.DamageUI(false, damage);
                        break;

                    case EnemyType.Boss:
                    case EnemyType.BossTower:
                        //statusUI_Boss.DamageUI(false, damage);
                        break;
                }
            }
